    ...
    <div class="container">
        ...
        <div class="header_content">
            ...
            <div class="header_buttons">
                <div class="row">
                    <div class="col-xs-12">
                        <a href="http://pineappme:81/index.php/user/registration">Регистрируйся</a>
                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                        <a href="http://pineappme:81/index.php/image/load">Загружай фото</a>
                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                ...
                <div class="tab_content">
                    <div class="tab_item">
                        <?php foreach ($images_data->result_array() as $row): ?>
                            <a href="http://pineappme:81/index.php/Image/getById/<?php echo $row['id_image']?>" ><img src="<?php echo '/../../img/mini/'.$row['path']; ?>" alt="Image"></a>
                        <?php endforeach; ?>
                    </div>
                    <!--
                    <div class="tab_item">
